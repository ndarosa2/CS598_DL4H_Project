...
def parse_arguments():
    ...
    # NJD - From original version of .py, changed default hiddenDimSize from 2000 to 10000 to match default value used in CUI + CCS version of .py 
    parser.add_argument('--hiddenDimSize', type=int, default=10000, help='Number of neurons in the hidden layer.')
    parser.add_argument('--batchSize', type=int, default=100, help='Batch size.')
    # NJD - From original version of .py, changed default nEpochs from 2000 to 5000 to match default value used in CUI + CCS version of .py  
